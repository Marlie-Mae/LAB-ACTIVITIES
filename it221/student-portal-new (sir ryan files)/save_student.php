...
if ($rows == "0") {
    // Insert New Record
    $sql = "INSERT INTO tbl_student_info (student_no, last_name, first_name, middle_name, course_code, year_level) 
            VALUES ('$student_no', '$last_name', '$first_name', '$middle_name', '$course_code', '$year_level')";
} else {
    // Update Existing Record
    $sql = "UPDATE tbl_student_info SET 
            last_name='$last_name', first_name='$first_name', middle_name='$middle_name', 
            course_code='$course_code', year_level='$year_level' WHERE student_no='$student_no'";
}
