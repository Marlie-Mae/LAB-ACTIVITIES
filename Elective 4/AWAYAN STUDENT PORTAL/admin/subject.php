<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == "POST" && !$isUser) {
        ...
        if (isset($_POST['edit_subject']) && !$isUser) {
...
<html>
    ...
    <div class="table-container">
        ...
        <button class="add-btn disabled-link" <?php if ($isUser) echo 'disabled'; else echo 'onclick="openModal()"'; ?>> <i class="fas fa-plus"></i> Add New Subject</button>
        ...
        <table id="subject" class="styled-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <button class="btn-edit disabled-link" <?php if ($isUser) echo 'disabled'; else echo 'onclick="openEditModal(\'' . $data['subject_code'] . '\', \'' . $data['subject_name'] . '\', \'' . $data['department_code'] . '\')"'; ?>> <i class="fas fa-edit"></i> Edit</button>
                        <?php if ($isUser): ?>
