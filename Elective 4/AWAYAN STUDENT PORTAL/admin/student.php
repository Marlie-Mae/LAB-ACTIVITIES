<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == "POST" && !$isUser) {
        ...
        if (isset($_POST['edit_student']) && !$isUser) {
...
<body>
    ...
    <div class="table-container">
        ...
        <button class="add-btn disabled-link" <?php if ($isUser) echo 'disabled'; else echo 'onclick="openModal()"'; ?>> <i class="fas fa-plus"></i> Add New Student</button>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="action-buttons">
                                <button class="btn-edit disabled-link" <?php if ($isUser) echo 'disabled'; else echo 'onclick="openEditModal(\'' . $data['student_no'] . '\', \'' . $data['first_name'] . '\', \'' . $data['last_name'] . '\', \'' . $data['middle_name'] . '\', \'' . $data['course_code'] . '\', \'' . $data['year_level'] . '\')"'; ?>> <i class="fas fa-edit"></i> Edit</button>
                                <?php if ($isUser): ?>
