...
if ($_SERVER['REQUEST_METHOD'] == "POST" && !$isUser) {
    ...
    if (isset($_POST['edit_course']) && !$isUser) {
...
<section class="main-content">
    ...
    <div class="table-container">
        ...
        <button class="add-btn disabled-link" <?php if ($isUser) echo 'disabled'; else echo 'onclick="openModal()"'; ?>> <i class="fas fa-plus"></i> Add New Course</button>
                ...
                <tr>
                    ...
                    <td>
                        <div class="action-buttons">
                            <button class="btn-edit disabled-link" <?php if ($isUser) echo 'disabled'; else echo 'onclick="openEditModal(\'' . $data['course_code'] . '\', \'' . $data['course_description'] . '\')"'; ?>> <i class="fas fa-edit"></i> Edit</button>
                            <?php if ($isUser): ?>
