<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == "POST" && !$isUser) {
        ...
        // EDIT USER FUNCTION
        if (isset($_POST['edit_user']) && !$isUser) {
   ...
   <nav class="sidebar">
     ...
     <section class="main-content">
        ...
        <div class="table-container">
            ...
            <button class="add-btn disabled-link" <?php if ($isUser) echo 'disabled'; else echo 'onclick="openModal()"'; ?>> <i class="fas fa-plus"></i> Add New User</button>
                ...
                <tr>
                    ...
                    <td>
                        <div class="action-buttons">
                            <button class="btn-edit disabled-link" <?php if ($isUser) echo 'disabled'; else echo 'onclick="openEditModal(\'' . $data['user_id'] . '\', \'' . $data['account_type'] . '\', \'' . $data['status'] . '\')"'; ?>> <i class="fas fa-edit"></i> Edit</button>
                            <?php if ($isUser): ?>
